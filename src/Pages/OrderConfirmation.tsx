const OrderConfirmation = () => {
    return (<>
        <section className="py-24 flex flex-col items-center">
            <div className="w-full max-w-7xl px-4 md:px-5 lg-6 flex flex-col items-center">
                ...
                <div className="main-box border border-gray-200 rounded-xl pt-6 max-w-2xl lg:max-w-full">
                    <div
